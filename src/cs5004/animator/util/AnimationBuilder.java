...
/**
 * This interface represents an AnimationBuilder object. It takes in the data parsed by the Reader
 * from the input file and populates the animation model with the data.
 */
