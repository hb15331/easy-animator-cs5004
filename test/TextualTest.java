...
/**
 * This JUnit class contains all the JUnit tests for the TextualView class.
 */
public class TextualTest {
  ...
  @Test
  public void toh3Test() throws IOException {
  ...
  @Test
  public void buildingsTest() throws IOException {
  ...
  public void zeroSpeedTest() throws IOException {
    ...
    AnimationModel model = AnimationReader
            .parseFile(new FileReader(new File("smalldemo.txt")), new Builder());
    StringBuilder out = new StringBuilder();
    AnimationViewInterface v = new TextualView();
